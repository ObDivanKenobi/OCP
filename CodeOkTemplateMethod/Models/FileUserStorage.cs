...
{
    public class FileUserStorage : UserStorage
    {
        ...
        public override QueryResult Save(User user)
        {
            if (user == null)
        ...
        public override User FindUserByLogin(string username, string passwordHash)
        {
            User result = null;
